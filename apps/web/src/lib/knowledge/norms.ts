...
export const NORMS: NormRef[] = [
  {
    ...
    domain: "estrutura",
    appliesWhen:
      "Sempre que o sistema usar perfis leves galvanizados (LSF) ou paredes/lajes em steel frame.",
    quickCheck:
      "Diafragmas, ancoragens e contraventamentos definidos por painel.",
  ...
  },
  {
    ...
    domain: "desempenho",
    appliesWhen:
      "Quando há uso habitacional, escritório administrativo permanente ou vestiário/refeitório regulares.",
    quickCheck:
      "Conforto térmico, acústico, estanqueidade e durabilidade ≥ Nível Mínimo.",
    url: "https://www.abntcatalogo.com.br/",
  },
  {
    code: "NBR 6120",
    ...
    domain: "cargas",
    appliesWhen:
      "Sempre. Define cargas permanentes, sobrecargas de piso e cargas variáveis.",
    quickCheck:
      "Sobrecarga de armazenagem ≥ 30 kN/m² (logística), 50–80 kN/m² (porta-paletes), 80–150 kN/m² (manufatura pesada).",
    url: "https://www.abntcatalogo.com.br/",
  },
  {
    code: "NBR 6123",
    ...
    domain: "vento",
    appliesWhen:
      "Sempre. Galpões altos e leves são sensíveis a vento (V0 por região, Categoria de rugosidade, fator topográfico).",
    quickCheck:
      "V0 entre 30 e 50 m/s no Brasil; verificar zona conforme mapa isopletas.",
    url: "https://www.abntcatalogo.com.br/",
  },
  {
    code: "NBR 8800",
    ...
    domain: "aco",
    appliesWhen:
      "Pórticos, vigas e pilares de aço laminado/soldado (sistemas porticos_aco e trelicado).",
    url: "https://www.abntcatalogo.com.br/",
  },
  {
    code: "NBR 14762",
    ...
    domain: "perfis_frio",
    appliesWhen:
      "Estruturas em perfis formados a frio (LSF, terças, longarinas).",
    url: "https://www.abntcatalogo.com.br/",
  },
  {
    code: "NBR 5410",
  ...
  },
  {
    ...
    domain: "hidraulica",
    appliesWhen:
      "Quando há banheiros, vestiários, refeitório, cozinha ou processo industrial.",
    url: "https://www.abntcatalogo.com.br/",
  },
  {
    code: "NBR 9077",
    ...
    domain: "incendio",
    appliesWhen:
      "Quando área coberta > 750 m² ou ocupação J/I/H/F com lotação relevante.",
    quickCheck:
      "Distância máxima a percorrer 30–40 m; nº mínimo de saídas conforme classificação.",
    url: "https://www.abntcatalogo.com.br/",
  },
  {
    code: "NBR 9050",
    ...
    appliesWhen:
      "Áreas com acesso de público, escritórios, vestiários e estacionamento.",
    url: "https://www.abntcatalogo.com.br/",
  },
];
